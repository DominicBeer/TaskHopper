...
namespace TaskHopper.RenderedGraphics
{
    static class TaskCardConstants
    {
        ...
        public readonly static Font PartFont = new Font("Arial", 8.0f);
        public readonly static Font NameFont = new Font("Arial", 10.0f);

        public readonly static Color OffBlack = Color.FromArgb(20, 20, 20);
        public readonly static Color LightGrey = Color.FromArgb(190, 190, 190);
